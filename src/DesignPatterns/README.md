...
Creational, behavioural, and (when added) structural design patterns with **Before** / **After** (or BadCode / GoodCode) examples.
...
Run the examples via the `Main` classes in each pattern’s Before/After (or BadCode/GoodCode) folder.
